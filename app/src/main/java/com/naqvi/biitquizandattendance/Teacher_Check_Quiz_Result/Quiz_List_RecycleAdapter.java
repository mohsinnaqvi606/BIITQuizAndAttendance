...
public class Quiz_List_RecycleAdapter extends RecyclerView.Adapter<Quiz_List_RecycleAdapter.AttendanceViewHolder> {

    public ArrayList<Quiz> quiz_List;
    public Context context;
    SharedReference SharedRef;

    public Quiz_List_RecycleAdapter(Context context, ArrayList<Quiz> quiz_List) {
    ...
    public void onBindViewHolder(AttendanceViewHolder holder, int position) {
        ...
        holder.parent_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, Quiz_Marks_Activity.class);
