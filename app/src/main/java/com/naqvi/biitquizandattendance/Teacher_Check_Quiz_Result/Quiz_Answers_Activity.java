...
import com.naqvi.biitquizandattendance.Student_Quiz_Result.Quiz_Answers;
import com.naqvi.biitquizandattendance.Student_Quiz_Result.Quiz_Result_Activity;
import com.naqvi.biitquizandattendance.Student_Quiz_Result.Student_Answer_List_Adapter;
...
public class Quiz_Answers_Activity extends AppCompatActivity {
    ...
    void Load_Result() {
        ...
        StringRequest request = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            ImgView.setImageBitmap(Bitmap.createScaledBitmap(bitmap, 450, 650, false));
                            if(type.equalsIgnoreCase("Teacher")){
                                ImgView.setImageBitmap(Bitmap.createScaledBitmap(bitmap, 850, 850, false));
                            }
                            ...
                            ImgView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    final Dialog nagDialog = new Dialog(Quiz_Answers_Activity.this);
                                 ...
                                 //   ivPreview.setImageBitmap(fullImage);
                                    ivPreview.setImageBitmap(Bitmap.createScaledBitmap(fullImage, 650, 850, false));
                            ...
                            Student_Answer_List_Adapter adapter = new Student_Answer_List_Adapter(Quiz_Answers_Activity.this,Answers);
                            lstAnswers.setAdapter(adapter);

                        } catch (JSONException e) {
                            String Msg = "You Did not Attempt this Quiz";
                            Toasty.error(Quiz_Answers_Activity.this,Msg,Toasty.LENGTH_LONG,true).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                Toasty.error(Quiz_Answers_Activity.this, error.getMessage(),Toasty.LENGTH_LONG,true).show();
            }
        });
